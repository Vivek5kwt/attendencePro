        ...
        child: StatefulBuilder(
          builder: (ctx, setState) {
            ...
            double scaledFont(double? base) =>
                responsive.scaleText(base ?? textTheme.bodyMedium?.fontSize ?? 16);
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.vertical(
                            top: Radius.circular(responsive.scale(30)),
                          ),
                        ),
                        padding: EdgeInsets.fromLTRB(
                          responsive.scale(28),
                          ...
                          children: [
                            ...
                            Text(
                              ...
                              style: textTheme.headlineSmall?.copyWith(
                                color: Colors.white,
                                fontWeight: FontWeight.w700,
                                fontSize: scaledFont(textTheme.headlineSmall?.fontSize),
                              ),
                            ),
                            ...
                            Text(
                              ...
                              style: textTheme.bodyMedium?.copyWith(
                                ...
                                fontSize: scaledFont(textTheme.bodyMedium?.fontSize),
                              ),
                            ),
                          ],
                        ),
                      ...
                      Container(
                        decoration: BoxDecoration(
                          color: Colors.white,
                          borderRadius: BorderRadius.vertical(
                            bottom: Radius.circular(responsive.scale(30)),
                          ),
                        ),
                        padding: EdgeInsets.symmetric(
                                        ...
                                        child: Text(
                                          ...
                                          style: textTheme.bodyLarge?.copyWith(
                                            ...
                                            fontWeight: isSelected
                                                ...
                                                : FontWeight.w500,
                                            fontSize:
                                                scaledFont(textTheme.bodyLarge?.fontSize),
                                          ),
                                        ),
                                      ),
                                    ],
                                  ...
                                  child: OutlinedButton(
                                    ...
                                    child: Text(
                                      ...
                                      style: textTheme.labelLarge?.copyWith(
                                        fontSize:
                                            scaledFont(textTheme.labelLarge?.fontSize),
                                      ),
                                    ),
                                  ),
                                ),
